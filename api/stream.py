...
# Tools removed - signup/login agent no longer needed
...
Generate 3 lines:
1. TITLE, PRICE: short name in all lowercase, with the price of the item (3-4 words, e.g., "sparkly ankle booties, $15")
